  ...
  <div>
    ...
    <div class="weekly-box horaire" v-if="isActive.weekly">
      <the-weekly-schedule :schedule="data.weekDaysSchedule" :today="data.today" :nextMonday="data.nextMonday"
        :isMobile="isMobile"></the-weekly-schedule>
    </div>
    <div class="horaire">
      <the-daily-schedule v-if="isActive.daily" :days="data.allDaysSchedule" :today="data.today" :tasks="allTasks.data">
      </the-daily-schedule>
    </div>
    <div class="horaire">
      <the-monthly-schedule class="monthly-schedule horaire" v-if="isActive.monthly" :schedule="data.allDaysSchedule">
